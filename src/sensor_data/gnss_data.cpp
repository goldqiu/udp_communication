...
#include "udp_communication/sensor_data/gnss_data.hpp"
...
//静态成员变量必须在类外初始化
double udp_communication::GNSSData::origin_latitude = 0.0;
double udp_communication::GNSSData::origin_longitude = 0.0;
double udp_communication::GNSSData::origin_altitude = 0.0;
bool udp_communication::GNSSData::origin_position_inited = false;
GeographicLib::LocalCartesian udp_communication::GNSSData::geo_converter;
